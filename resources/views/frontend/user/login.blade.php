...
<html>
	...
	<body>
		...
		<form  method="post" action="{{url('user/loginDo')}}" class="form center">
			{{csrf_field()}}
		<div class="login">
			<div class="login_center">
				...
				<div class="login_main center">
					<div class="username">用户名:&nbsp;<input class="shurukuang" type="text" name="username" placeholder="请输入你的用户名" value="{{old('username')}}"/></div>
